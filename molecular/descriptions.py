...
LINK_FRICTION = 'Friction in links , a kind of viscosity. Slow down tangent velocity. 0 = no friction , 1.0 = full friction'
...
LINK_MAX = 'Maximum number of links per particles'
LINK_STIFFNESS = 'Stiffness of links between particles'
LINK_STIFFNESS_RANDOM = 'Random variation for stiffness'
LINK_STIFFNESS_EXPONENT = 'Give an exponent force to the spring links'
LINK_DAMPING = 'Damping effect on spring links'
LINK_DAMPING_RANDOM = 'Random variation on damping'
LINK_BROKEN = 'How much links can stretch before they are broken. 0.01 = 1% , 0.5 = 50% , 2.0 = 200% ...'
...
LINK_EXPENSION_STIFFNESS_EXPONENT = 'Give an exponent force to the expension spring links'
...
LINK_EXPENSION_BROKEN = 'How much links can expand before they are broken. 0.01 = 1% , 0.5 = 50% , 2.0 = 200% ...'
...
RELINK_CHANCE = 'Chance of a new link created on collision. 0 = off , 100 = 100% chance'
...
RELINK_MAX = 'Maximum number of links per particles'
RELINK_STIFFNESS = 'Stiffness of links between particles'
RELINK_STIFFNESS_RANDOM = 'Random variation for stiffness'
RELINK_STIFFNESS_EXPONENT = 'Give an exponent force to the spring links'
RELINK_DAMPING = 'Damping effect on spring links'
RELINK_DAMPING_RANDOM = 'Random variation on damping'
RELINK_BROKEN = 'How much links can stretch before they are broken. 0.01 = 1% , 0.5 = 50% , 2.0 = 200% ...'
...
RELINK_EXPENSION_STIFFNESS_EXPONENT = 'Give an exponent force to the spring links'
